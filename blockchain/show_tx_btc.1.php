...
$user_id=get_current_user_id();
    ...
    if(empty($coin_address)){
        ...
        for ($i = 0 ; $i < $n_tx; $i++) {
            ...
            echo '<td>'.date('m/d/Y H:i:s', $json->txs[$i]->time).'</td>';
