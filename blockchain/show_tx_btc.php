    ...
    if(empty($coin_address)){
        ...
        while($json->txs[$j]->tx_index) {
            ...
            if($wpdb->get_row($sql)>0){ //이미 레코드가 있으면
                ...
                curl_close($ch);
                /////////////////////////////////////////////
                $current_time=time(); //UNIX Timestamp style임
                ...
                $wpdb->query($sql);
                echo "<br>------------------------------".$j;
                echo "<br>Current WIIX COIN Price: ".$wiix_coin_price_in_usd." USD";
        ...
        echo "<br>Total Received: ".$total_received." Satoshi";
        echo "<br>Final Balance: ".$final_balance." Satoshi";
        echo '<br><br>';
        echo '<table class="table table-hover table-responsive">';
        echo '<tr>';
        echo '<th>Transaction ID</th>';
        echo '<th>Transaction Date & Time</th>';
